...
#define TORCH_ANGSTROM_TO_BOHR ((real)1.8897261246257702)
#define TORCH_HARTREE_TO_KCALPERMOLE ((real)627.5094740659184)
#define TORCH_FORCE_TO_CHARMM ((real)1185.82104659254322762040617035168)
#define TORCH_F_EV_TO_KCALMOL ((real)23.060547830619)   // double literal
#define TORCH_E_EV_TO_KCALMOL ((real)23.060547830619)   // double literal
#define TORCH_F_HARTREE_TO_KCALMOL ((real)627.5094740631)
#define TORCH_E_HARTREE_TO_KCALMOL ((real)627.5094740631)
#define EV_TO_KCALMOL ((real)23.060547830619)
#endif   // eemlp-end
